...
public class NewMessageNotification {
    ...
    public static void notify(final Context context,final String exampleString, final int number,String text,int id_trouver,double lat,double lng,int nb_point) {
        ...
        i.putExtra("id_trouver", id_trouver);
        i.putExtra("lat", lat);
        i.putExtra("lng", lng);
    ...
    public static void notify2(final Context context,final String exampleString, final int number,String text,int attendu) {
        final Resources res = context.getResources();
    ...
    public static void notify4(final Context context,final String exampleString, final int number,String text,int id_donner,double lat,double lng,int nb_point) {
        final Resources res = context.getResources();
        ...
        i.putExtra("id_donner", id_donner);
        i.putExtra("lat", lat);
        i.putExtra("lng", lng);
        i.putExtra("nb_point", nb_point);
        i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
